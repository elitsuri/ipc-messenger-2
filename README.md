...
> IPC Messenger: C inter-process communication with message queues and shared memory
...
## 🏗️ Architecture
Three-tier architecture: C, MQTT backend, native frontend, PostgreSQL database. Containerized with Docker.
...
git clone https://github.com/elitsuri/ipc-messenger
cd ipc-messenger
